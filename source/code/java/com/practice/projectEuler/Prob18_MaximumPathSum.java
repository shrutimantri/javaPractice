 ...
 */
public class Prob18_MaximumPathSum {
    public static void main(String[] args) throws Exception{
        String filePath = "javaModule/source/code/java/com/practice/projectEuler/files/prob18Triangle.txt";
        int[][] inputTriangle = readInput(filePath);
        /*for(int i = 0; i < inputTriangle.length; i++){
            for(int j = 0; j<=i; j++){
                System.out.print(inputTriangle[i][j] +" ");
            }
            System.out.print("\n");
        }*/
